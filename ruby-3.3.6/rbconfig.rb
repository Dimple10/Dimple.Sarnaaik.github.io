...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/fangirl/.rubies/ruby-3.3.6")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/fangirl/.rubies/ruby-3.3.6' '--with-opt-dir=/usr/local/opt/libyaml'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/fangirl/.rubies/ruby-3.3.6"
  ...
  CONFIG["DLDFLAGS"] = "-L/usr/local/opt/libyaml/lib -Wl,-undefined,dynamic_lookup"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["incflags"] = "-I/usr/local/opt/libyaml/include"
  ...
  CONFIG["LDFLAGS"] = "-L. -fstack-protector-strong -L/usr/local/opt/libyaml/lib"
