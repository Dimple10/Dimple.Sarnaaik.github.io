...
extensions = ext/-test-/RUBY_ALIGNOF/. ext/-test-/abi/. \
	     ...
	     ext/rbconfig/sizeof/. ext/ripper/. ext/rubyvm/. \
	     ext/socket/. ext/stringio/. ext/strscan/. ext/syslog/. \
	     ext/zlib/. .bundle/gems/debug-1.9.2/ext/debug/. \
	     .bundle/gems/racc-1.7.3/ext/racc/cparse/. \
	     .bundle/gems/rbs-3.4.0/ext/rbs_extension/.
EXTOBJS = dmyext.o
...
.bundle/gems/debug-1.9.2/ext/debug/all:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/racc-1.7.3/ext/racc/cparse/all:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
...
.bundle/gems/debug-1.9.2/ext/debug/static:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/racc-1.7.3/ext/racc/cparse/static:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
...
.bundle/gems/debug-1.9.2/ext/debug/install:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/racc-1.7.3/ext/racc/cparse/install:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
...
.bundle/gems/debug-1.9.2/ext/debug/install-so:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/racc-1.7.3/ext/racc/cparse/install-so:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
...
.bundle/gems/debug-1.9.2/ext/debug/install-rb:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/racc-1.7.3/ext/racc/cparse/install-rb:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
...
ext/zlib/clean:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/debug-1.9.2/ext/debug/clean:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/racc-1.7.3/ext/racc/cparse/clean:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/rbs-3.4.0/ext/rbs_extension/clean:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
...
ext/zlib/distclean:
	...
	$(Q)$(RMDIRS) $(@D)
.bundle/gems/debug-1.9.2/ext/debug/distclean:
	$(ECHO) $(@F)ing $(@D)
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
	$(Q)$(RM) .bundle/gems/debug-1.9.2/exts.mk
	$(Q)$(RMDIRS) $(@D)
.bundle/gems/racc-1.7.3/ext/racc/cparse/distclean:
	$(ECHO) $(@F)ing $(@D)
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
	$(Q)$(RM) .bundle/gems/racc-1.7.3/exts.mk
	$(Q)$(RMDIRS) $(@D)
.bundle/gems/rbs-3.4.0/ext/rbs_extension/distclean:
	$(ECHO) $(@F)ing $(@D)
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
	$(Q)$(RM) .bundle/gems/rbs-3.4.0/exts.mk
	$(Q)$(RMDIRS) $(@D)
...
ext/zlib/realclean:
	...
	$(Q)$(RM) ext/zlib/exts.mk
	$(Q)$(RMDIRS) $(@D)
.bundle/gems/debug-1.9.2/ext/debug/realclean:
	$(ECHO) $(@F)ing $(@D)
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
	$(Q)$(RM) .bundle/gems/debug-1.9.2/exts.mk
	$(Q)$(RMDIRS) $(@D)
.bundle/gems/racc-1.7.3/ext/racc/cparse/realclean:
	$(ECHO) $(@F)ing $(@D)
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
	$(Q)$(RM) .bundle/gems/racc-1.7.3/exts.mk
	$(Q)$(RMDIRS) $(@D)
.bundle/gems/rbs-3.4.0/ext/rbs_extension/realclean:
	$(ECHO) $(@F)ing $(@D)
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
	$(Q)$(RM) .bundle/gems/rbs-3.4.0/exts.mk
	$(Q)$(RMDIRS) $(@D)
...
note-body:: note-header
	...
	"	/Users/fangirl/Repos/Dimple.Sarnaaik.github.io/ruby-3.3.6/ext/openssl/extconf.rb:122: OpenSSL library could not be found. You might want to use --with-openssl-dir=<dir> option to specify the prefix where OpenSSL is installed." \
